...
local colors = {
	...
	keyword = "#726d8a",
	-- string = "#9eaaaa", -- Muted Teal/Gray
	string = "#9eb5b5", -- Muted Teal/Gray
...
-- Pmenu (Completion)
hl(0, "Pmenu", { fg = "#777777", bg = "#151719" })
...
hl(0, "@tag.attribute", { fg = colors.keyword })
...
hl(0, "@tag", { fg = colors.bright_fg, bold = true }) -- <div>, <body>
-- hl(0, "@tag", { fg = "#999083", bold = true }) -- <div>, <body>
hl(0, "@tag.delimiter", { fg = colors.info }) -- <, >, />
hl(0, "@tag.attribute", { fg = colors.keyword }) -- class, id, href
...
hl(0, "@punctuation.delimiter.javascript", { fg = colors.info }) -- JS delimiters like {} []
hl(0, "@punctuation.bracket.javascript", { fg = colors.info }) -- JS brackets like {}, [], ()
-- hl(0, "@punctuation.bracket.javascript", { fg = "#bddcdc" }) -- JS brackets like {}, [], ()
